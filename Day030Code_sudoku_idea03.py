...
#
#     I am saving this with all the prints because I got it working
#     having an x in the .csv file messed up the logic.  I could not keep
#     strings and int working
#
################################################################################
#
