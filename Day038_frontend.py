...
###############################################################################
"""
It looks like you can put notes in side tripple quotes and it act as a txt file.

This is a program to store book informatoin:
Title, Author, Year, ISBN

User can:
view all records, search an entry, add entry, update entry, delete and close
"""
# Import everything from tkinter
from tkinter import *
#  Create a new script and import the script
import backend
